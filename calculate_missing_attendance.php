...
if(count($RET))
echo '<br/><table><tr><td width="38"><img src="assets/icon_ok.png" /></td><td valign="middle"><span style="font-size:14px;">'._('Missing attendance data list created.').'</span></td></tr></table>';
//else
