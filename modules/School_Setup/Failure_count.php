...
echo '<tr><td width="92%" align="right">'._('No. of login failures allowed before account is disabled').':</td><td align="left">'.TextInput($failure['FAIL_COUNT'],'failure[FAIL_COUNT]','','class=cell_floating').'</td></tr>';
