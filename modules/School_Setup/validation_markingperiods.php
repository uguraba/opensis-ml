...
include('../../Redirect_modules.php');
	...
	function formcheck_school_setup_marking_onedit(){
  	...
  	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][TITLE]","req,"'._('Please enter the title').'");
  	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][TITLE]","maxlen=50","'._( 'Max length for title is 50').'");
	...
	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][SHORT_NAME]","req","'._('Please enter the Short Name').'");
  	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][SHORT_NAME]","maxlen=10","'._( 'Max length for Short Name is 10').'");
	...
	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][SORT_ORDER]","maxlen=5","'._( "Max length for Short Order is 5").'");
  	frmvalidator.addValidation("tables['.$_REQUEST['marking_period_id'].'][SORT_ORDER]","num","'._( "Enter Only Numeric Value").'");
...
if (false==isDate(sm, sd, sy))
   {
<<<<<<< .mine
   alert("'._("Please enter the Start Date").'");
=======
   alert("'._("Please enter the Start Date").'");
>>>>>>> .r1635
   sm.focus();
...
{  
   ...
   {
   alert("'._("Please Enter the End Date").'");
   em.focus();
   return false;
   }
}   
