...
echo "<div class=maintenance><a href=Modules.php?modname=$_REQUEST[modname]&page_display=MAINTENANCE><strong>"._('Put system in maintenance mode')."</strong></a></div>";
echo "<div class=currency><a href=Modules.php?modname=$_REQUEST[modname]&page_display=CURRENCY><strong>"._('Set Currency')."</strong></a></div>";
echo "<div class=class_rank><a href=Modules.php?modname=$_REQUEST[modname]&page_display=CLASSRANK><strong>"._('Display Class Rank')."</strong></a></div>";
echo '</div>';
}
