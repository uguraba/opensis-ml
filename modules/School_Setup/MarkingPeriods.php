		...
		foreach($_REQUEST['tables'] as $id=>$columns)
		{
                    ...
                    if($id!='new')
                        ...
                        $asso_err=false;
                                ...
                                if($days<=0)
                                {
                                        $err_msg=(_('Data not saved because start and end date is not valid'));
                                }
                                else 
                                {
                                        ...
                                        {
                                             if($days==0)
                                                $err_msg=(_('Please Give a Grade Posting Begins and End Date'));
                                            else
                                                $err_msg=(_('Data not saved because grade posting date is not valid'));
                                            $error=true;  
                                        }
                                                ...
                                                foreach($columns as $column=>$value)
                                                {
                                                        ...
                                                        if($column=='START_DATE' && $columns['START_DATE']!='')
                                                        {
                                                            if($_REQUEST['mp_term']!='FY')
                                                            {
                                                                ...
                                                                {
                                                                    $err_msg=''._('Start date cannot be earlier than')._(' ')._($nm)._(' ')._('start date').'';
                                                                    break 2;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                if($dates['START_DATE']!='')
                                                                {
                                                                    ...
                                                                    { 
                                                                        ...
                                                                        {
                                                                            $err_msg=(_('Start date cannot be earlier than previous year end date'));
                                                                            break 2;
                                                                        }
                                                                        else
                                                                        {
...
//                                                                         print_r($attendance_calendar);
                                                                            ...
                                                                            if(strtotime($columns['START_DATE'])>strtotime($attendance_calendar[1]['START_DATE']))
                                                                            {
                                                                             ...
                                                                             $err_msg=(_('Start date cannot be changed  because the calender has already been created'));
                                                                             break 2; 
                                                                            }
                                                                            else
                                                                            {  
                                                                                ...
                                                                                {
                                                                                $err_msg=(_('Start date cannot be changed because the SYEAR is associated with students'));
                                                                                    break 2; 
                                                                                }
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                    $err_msg=(_('Start date cannot be changed because the SYEAR is associated with staff'));
                                                                                        break 2; 
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                        $err_msg=(_('Start date cannot be changed because the SYEAR is associated with subjects'));
                                                                                            break 2; 
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                            $err_msg=(_('Start date cannot be changed because the SYEAR is associated with attendance codes'));
                                                                                                break 2; 
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                ...
                                                                                                {
                                                                                                $err_msg=(_('Start date cannot be changed because the SYEAR is associated with school periods'));
                                                                                                    break 2; 
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    ...
                                                                                                    {
                                                                                                        $err_msg=(_('Start date cannot be changed because the SYEAR already exists in previous year'));
                                                                                                        break 2;
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                    ...
                                                                    {
                                                                        $err_msg=_('Start date cannot be after')._(' ')._($nm)._(' ')._('start date');
                                                                        break 2;
                                                                    }
                                                                }
                                                                else 
...
//                                                                         print_r($attendance_calendar);
                                                        ...
                                                        if($column=='END_DATE' && $columns['END_DATE']!='')
                                                        {
                                                            ...
                                                            if($_REQUEST['mp_term']!='FY')
                                                            {
                                                                ...
                                                                { 
                                                                    $err_msg=""._('End date cannot be after ')._($nm)." "._('end date')."";
                                                                    break 2;
                                                                }
                                                            }
                                                            else
...
//                                                                         print_r($attendance_calendar);
                                                                            ...
                                                                            if($attendance_calendar[1]['END_DATE']!='' && strtotime($columns['END_DATE'])>strtotime($attendance_calendar[1]['END_DATE']))
                                                                            {
                                                                             ...
                                                                             $err_msg=""._('End date cannot be changed  because the calender has already been created')."";
                                                                             break 2; 
                                                                            }
                                                                        if($value!='')
                                                                        {   
                                                                    ...
                                                                    { 
                                                                        $err_msg=""._('End date cannot be before')._(' ')._($nm)._('end date')."";
                                                                        break 2;
                                                                    }
                                                                }
                                                                else
...
//                                                            {
                                                                if($value!='')
                                                                {
                                                                    ...
                                                                    {
                                                                        $err_msg=""._('Grade Posting Begins date can not occur before the Marking Period Begins date')."";
                                                                        break 2;
                                                                    }   
                                                                }
                                                                else 
				...
				foreach($columns as $column=>$value)
				{
					...
					if($value)
					{
                                            if($column=='START_DATE' && $columns['START_DATE']!='')
                                            {
                                                ...
                                                {
                                                    $err_msg=""._('Start date cannot be earlier than ')._($nm)._(' start date')."";
...
//                                                    }
			...
			if($go)
				DBQuery($sql);
                        if($asso_err)
                            $err_msg=''._('Start Date or End Date cannot be changed because marking period has association').'';
//----------------------------------------------------------------------------------------------------------------------		
                                            if($go){
...
{
	if($_REQUEST['marking_period_id']!='new')
		$delete_button = "<INPUT type=button class=btn_medium value="._('Delete')." onClick='load_link(\"Modules.php?modname=$_REQUEST[modname]&modfunc=delete&mp_term=$_REQUEST[mp_term]&year_id=$_REQUEST[year_id]&semester_id=$_REQUEST[semester_id]&quarter_id=$_REQUEST[quarter_id]&marking_period_id=$_REQUEST[marking_period_id]\")'>";
	...
	if($err_msg)
        {
            echo "<b style='color:red'>"._($err_msg)."</b>";
		...
		$header .= '<TR><td class=lable >'._('Title').'</td><TD>' . TextInput($RET['TITLE'],'tables['.$_REQUEST['marking_period_id'].'][TITLE]','','class=cell_floating') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Short Name').'</td><TD>' . TextInput($RET['SHORT_NAME'],'tables['.$_REQUEST['marking_period_id'].'][SHORT_NAME]','','class=cell_floating') . '</TD></tr>';
		
		if(clean_param($_REQUEST['marking_period_id'],PARAM_ALPHANUM)=='new')
			$header .= '<TR><td class=lable>'._('Sort Order').'</td><TD>' . TextInput($RET['SORT_ORDER'],'tables['.$_REQUEST['marking_period_id'].'][SORT_ORDER]','','class=cell_small onKeyDown="return numberOnly(event);"') . '</TD></tr>';
		else
			$header .= '<TR><td class=lable>'._('Sort Order').'</td><TD>' . TextInput($RET['SORT_ORDER'],'tables['.$_REQUEST['marking_period_id'].'][SORT_ORDER]','','class=cell_small onKeyDown=\"return numberOnly(event);\"') . '</TD></tr>';
			
		$header .= '<TR><td class=lable>'._('Graded').'</td><TD>' . CheckboxInput($RET['DOES_GRADES'],'tables['.$_REQUEST['marking_period_id'].'][DOES_GRADES]','',$checked,$_REQUEST['marking_period_id']=='new','<IMG SRC=assets/check.gif height=15 vspace=0 hspace=0 border=0>','<IMG SRC=assets/x.gif height=15 vspace=0 hspace=0 border=0>') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Exam').'</td><TD>' . CheckboxInput($RET['DOES_EXAM'],'tables['.$_REQUEST['marking_period_id'].'][DOES_EXAM]','',$checked,$_REQUEST['marking_period_id']=='new','<IMG SRC=assets/check.gif height=15 vspace=0 hspace=0 border=0>','<IMG SRC=assets/x.gif height=15 vspace=0 hspace=0 border=0>') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Comments').'</td><TD>' . CheckboxInput($RET['DOES_COMMENTS'],'tables['.$_REQUEST['marking_period_id'].'][DOES_COMMENTS]','',$checked,$_REQUEST['marking_period_id']=='new','<IMG SRC=assets/check.gif height=15 vspace=0 hspace=0 border=0>','<IMG SRC=assets/x.gif height=15 vspace=0 hspace=0 border=0>') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Begins').'</td><TD>' . DateInput($RET['START_DATE'],'tables['.$_REQUEST['marking_period_id'].'][START_DATE]','') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Ends').'</td><TD>' . DateInput($RET['END_DATE'],'tables['.$_REQUEST['marking_period_id'].'][END_DATE]','') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Grade Posting Begins').'</td><TD>' . DateInput($RET['POST_START_DATE'],'tables['.$_REQUEST['marking_period_id'].'][POST_START_DATE]','') . '</TD></tr>';
		$str_srch='<TR><td class=lable>'._('Comments').'</td><TD>' . CheckboxInput($RET['DOES_COMMENTS'],'tables['.$_REQUEST['marking_period_id'].'][DOES_COMMENTS]','',$checked,$_REQUEST['marking_period_id']=='new','<IMG SRC=assets/check.gif height=15 vspace=0 hspace=0 border=0>','<IMG SRC=assets/x.gif height=15 vspace=0 hspace=0 border=0>') . '</TD></tr>';
		$header .= '<TR><td class=lable>'._('Grade Posting Ends').'</td><TD>' . DateInput($RET['POST_END_DATE'],'tables['.$_REQUEST['marking_period_id'].'][POST_END_DATE]','') . '</TD></tr>';
		...
		if(clean_param($_REQUEST['marking_period_id'],PARAM_ALPHANUM)=='new')
			DrawHeaderHome('','',AllowEdit()?'<INPUT type=submit value='._("Save").' class="btn_medium" onclick="formcheck_school_setup_marking();">':'');
		elseif($_REQUEST['mp_term']!='FY')
			DrawHeaderHome('','',AllowEdit()?$delete_button.'&nbsp;&nbsp;<INPUT type=submit name=btn_save id=btn_save value='._("Save").' class="btn_medium">':'');
                else
                        DrawHeaderHome('','','<INPUT type=submit name=btn_save id=btn_save value='._("Save").' class="btn_medium">');
