...
PopTable ('header',''._('Upload School Logo').'');
...
//	$upload->fileExtension;
    ...
    {
    $msg = "<font color=red><b>"._('Cannot upload file. Only jpeg, jpg, png, gif files are allowed.')."</b></font>";
    echo '
	'.$msg.'
	<form enctype="multipart/form-data" action="Modules.php?modname=School_Setup/UploadLogo.php&action=upload" method="POST">';
echo '<div align=center>'._('Select Logo').': <input name="file" type="file" /><br /><br>
<input type="submit" value='._("Upload").' name="Submit" class=btn_medium />&nbsp;<input type=button class=btn_medium value='._('Cancel').' onclick=\'load_link("Modules.php?modname=School_Setup/Schools.php");\'></div>
</form>';
PopTable ('footer');
    }
  	else
...
fclose($upload->target_path);
 ...
 echo '<div align=center><input type=button class=btn_medium value='._("Done").' onclick=\'load_link("Modules.php?modname=School_Setup/Schools.php");\'></div>';
	PopTable ('footer');
    }
}
else
...
<form enctype="multipart/form-data" action="Modules.php?modname=School_Setup/UploadLogo.php&action=upload" method="POST">';
echo '<div align=center>'._("Select Logo").' <input name="file" type="file" />"<br /><br>
<input type="submit" name="Submit"  value='._("Upload").' class=btn_medium />&nbsp;<input type=button class=btn_medium value='._('Cancel').' onclick=\'load_link("Modules.php?modname=School_Setup/Schools.php");\'></div>
</form>';
PopTable ('footer');
}
}
...
{
	echo ''._('Please select a school first!').'';
	PopTable ('footer');
}
?>