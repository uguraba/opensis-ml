...
$m_options = array('AM'=>''._('AM').'','PM'=>''._('PM').'');
...
echo '<TR><TD colspan=5 align=center>'.SubmitButton(_('Save'),'','class=btn_medium onclick="formcheck_eligibility_entrytimes();"').'</TD></TR>';
echo '</TABLE>';
echo '</FORM>';
