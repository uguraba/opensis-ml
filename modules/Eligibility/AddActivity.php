...
if(optional_param('modfunc','',PARAM_NOTAGS)=='save')
{
	if($_REQUEST['activity_id'])
	{
		...
		$note = _("That activity has been added to the selected students.");
	}
	else
...
if($_REQUEST['search_modfunc']=='list')
{
	...
	echo '<CENTER><TABLE cellpadding=6><TR><TD align=right><b>'._('Activity').'</b></TD>';
	echo '<TD>';
...
//	echo '<BR><CENTER>'.SubmitButton('Add Activity to Selected Students','','class=btn_xlarge onclick=\'formload_ajax("addact");\'')."</CENTER></FORM>";
	echo '<BR><CENTER>'.SubmitButton(_('Add Activity to Selected Students'),'','class=btn_xlarge')."</CENTER></FORM>";
