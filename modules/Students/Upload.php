...
PopTable ('header',''._("Upload Student's Photo").'');
...
<input type="submit" value='._("Upload").' class=btn_medium />&nbsp;<input type=button class=btn_medium value='._('Cancel').' onclick=\'load_link("Modules.php?modname=Students/Student.php");\'></div>
</form>';
PopTable ('footer');
    }
  	else
...
{
	echo ''._('Please select a student first! from the').' <b>'._("Students").'</b> Tab';
	PopTable ('footer');
}
?>