...
#$relation_options = array('Father'=>'Father','Mother'=>'Mother','Emergency'=>'Emergency');
$relation_options = array('Father'=>_('Father'),'Mother'=>_('Mother'),'Step Mother'=>_('Step Mother'),'Step Father'=>_('Step Father'),'Grandmother'=>_('Grandmother'),'Grandfather'=>_('Grandfather'),'Legal Guardian'=>_('Legal Guardian'),'Other Family Member'=>_('Other Family Member'));
if($info_apd)
