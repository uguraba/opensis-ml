...
if(!$_REQUEST['modfunc'])
{
	...
	if($_REQUEST['search_modfunc']=='list')
	{
		...
		{
			$extra['extra_header_left'] .= '<TR><TD><INPUT type=checkbox name=teacher value=Y>'._('Teacher').'</TD></TR>';
			$extra['extra_header_left'] .= '<TR><TD><INPUT type=checkbox name=room value=Y>'._('Room').'</TD></TR>';
		}
