...
//		}
                     if($error){
                         ShowErrPhp(_('Can\'t edit "Type" because it is not editable'));
                    }
		}
		else
		{
...
{	global $THIS_RET;
	...
	if($name=='TYPE')
		$options = array('Add'=>''._('Add').'','Drop'=>''._('Drop').'','Roll'=>''._('Roll Over').'','TrnD'=>''._('Drop(Transfer)').'','TrnE'=>''._('Enroll(Transfer)').'');
