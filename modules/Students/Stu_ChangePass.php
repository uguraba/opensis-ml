...
echo "<tr><td align='right'><strong>"._('Old Password :')."</strong> </td><td><INPUT type=password class=cell_floating name=old AUTOCOMPLETE = �off�></td></tr>";
echo "<tr><td align='right'><strong>"._('New Password :')."</strong> </td><td><INPUT type=password class=cell_floating name=new AUTOCOMPLETE = �off�></td></tr>";
echo "<tr><td align='right'><strong>"._('Retype Password :')."</strong> </td><td><INPUT type=password class=cell_floating name=retype AUTOCOMPLETE = �off�></td></tr>";
echo "</table></td></tr></table>";
DrawHeader('','',"<INPUT TYPE=SUBMIT name=button id=button class=btn_medium VALUE='"._('Save')."' onclick='return change_pass();'></CENTER>");
echo "</FORM>";
PopTable('footer');
