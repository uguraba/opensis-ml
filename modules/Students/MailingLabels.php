...
if(!$_REQUEST['modfunc'])
{
	...
	if($_REQUEST['search_modfunc']=='list')
	{
		...
		$extra['extra_header_left'] .= '<TR><TD colspan=2>'._('Avery Label 15660, 18660, 28660, 5630, 5660, 8660, 5620, 8620 compatible').'
</TD></TR>';
		$extra['extra_header_left'] .= '<TR><TD><INPUT type=radio name=to_address value="student" checked>'._('To Student').'</TD></TR>';
		$extra['extra_header_left'] .= '<TR><TD><INPUT type=radio name=to_address value="pri_contact">'._('To Primary Emergency Contact').'</TD></TR>';
		$extra['extra_header_left'] .= '<TR><TD><INPUT type=radio name=to_address value="sec_contact">'._('To Secondary Emergency Contact').'</TD></TR>';
		$extra['extra_header_left'] .= '<TR><TD><INPUT type=radio name=to_address value="contact">'._('To Both Emergency Contacts').'</TD></TR>';
	...
	if($_REQUEST['search_modfunc']=='list')
	{
		echo '<BR><CENTER><INPUT type=submit class=btn_xxlarge value=\''._('Create Labels for Selected Students').'\'></CENTER>';
		echo "</FORM>";
	}
}
