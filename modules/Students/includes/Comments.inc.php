...
*/
	...
	$columns = array('USER_NAME'=>''._('Entered By').'','COMMENT_DATE'=>''._('Date').'','COMMENT'=>''._('Comments').'');
	...
	ListOutput($comments_RET,$columns,''._('Comment').'',''._('Comments').'',$link,array(),array('search'=>false));
