...
{
	$singular = ''._('Student with an incomplete schedule').'';
	$plural = ''._('Students with incomplete schedules').'';
	...
	ListOutput($bad_students,array('FULL_NAME'=>_('Student'),'STUDENT_ID'=>_('Student ID'),'GRADE_ID'=>_('Grade'))+$extra['columns_after'],$singular,$plural,$link);
	echo "</div>";
}
