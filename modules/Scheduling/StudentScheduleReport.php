...
if($_REQUEST['modfunc']=='save')
{
	...
	$columns = array('DAYS'=>''._('Days').'','DURATION'=>''._('Time').'','PERIOD_TITLE'=>''._('Period - Teacher').'','ROOM'=>''._('Room')._(' / ')._('Location').'','MARKING_PERIOD_ID'=>''._('Term').'','DAYS'=>''._('Days').'','COURSE_TITLE'=>''._('Course').'');
	...
	if(count($RET_stu))
	{
		...
		# --------------------------------------- Start Change ------------------------------------------- #
			...
			echo '<table style="border-collapse: collapse;" width="100%" align="center" border="1px solid #a9d5e9 " cellpadding="6" cellspacing="1">';
					echo '<tr><td width=15% bgcolor="#d3d3d3"><strong>'._('Days').'</strong></td>';
					echo '<td bgcolor="#d3d3d3"><strong>'._('Start Time').'</strong></td>';
					echo '<td bgcolor="#d3d3d3"><strong>'._('End Time').'</strong></td>';
					echo '<td bgcolor="#d3d3d3"><strong>'._('Period - Teacher').'</strong></td>';
					echo '<td bgcolor="#d3d3d3"><strong>'._('Marking Period').'</strong></td>';
					echo '<td bgcolor="#d3d3d3"><strong>'._('Room')._(' / ')._('Location').'</strong></td>';
					echo '</tr>';
		...
		BackPrompt(_('No Records were found.'));
	}
...
if(!$_REQUEST['modfunc'])
{
	...
	PopTable_wo_header ('header');
		...
		# ---------------------------------------- Marking period selection Start ------------------------------------------ #
                        echo '<TABLE border=0 align=left><tr><td>'._('Please select the Marking Period').' :</td><TD valign=middle style=padding-top:25px;>';
...
if(count($RET_show))
	{
        foreach($RET_show as $student_id=>$courses)
		{
			...
			echo '<table class="grid" width="100%" align="center" cellpadding="6" cellspacing="1">';
					echo '<tr><td width=15% class="column_heading"><strong>'._('Days').'</strong></td>';

					echo '<td class="column_heading"><strong>'._('Start Time').'</strong></td>';
					echo '<td class="column_heading"><strong>'._('End Time').'</strong></td>';
					echo '<td class="column_heading"><strong>'._('Period - Teacher').'</strong></td>';
					echo '<td class="column_heading"><strong>'._('Marking Period').'</strong></td>';
					echo '<td class="column_heading"><strong>'._('Room')._(' / ')._('Location').'</strong></td>';
					echo '</tr>';
		$ar=array('Sunday'=>'U','Monday'=>'M','Tuesday'=>'T','Wednesday'=>'W','Thursday'=>'H','Friday'=>'F','Saturday'=>'S');
		foreach($ar as $day=>$value)
		{
...
#############################################################################################
		...
		echo '<BR><CENTER><INPUT type=submit class=btn_medium value=\''._('Print').'\'></CENTER>';
		echo "</FORM>";
