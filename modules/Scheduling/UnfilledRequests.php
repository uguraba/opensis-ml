...
$extra['columns_after'] = array('COURSE'=>''._('Request').'','AVAILABLE_SEATS'=>''._('Available Seats').'','SECTIONS'=>''._('Sections').'','WITH_TEACHER_ID'=>''._('Teacher').'','WITH_PERIOD_ID'=>''._('Period').'');
$extra['singular'] = ''._('Unscheduled Request').'';
$extra['plural'] = ''._('Unscheduled Requests').'';
