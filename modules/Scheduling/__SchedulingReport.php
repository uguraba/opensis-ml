...
if(!$_REQUEST['modfunc'])
{
	...
	$columns = array('FULL_NAME'=>''._('Student').'','STUDENT_ID'=>''._('Student ID').'','COURSE'=>''._('Course').'');
	...
	ListOutput($RET,$columns,''._('Unscheduled Request').'',''._('Unscheduled Requests').'',$link,array(array('FULL_NAME','STUDENT_ID')));
}
?>