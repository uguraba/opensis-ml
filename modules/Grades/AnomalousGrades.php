...
$columns = array('FULL_NAME'=>_('Name'),'STUDENT_ID'=>_('Student ID'),'POINTS'=>_('Problem'),'TYPE_TITLE'=>_('Category'),'TITLE'=>_('Assignment'),'COMMENT'=>_('Comment'));
ListOutput($students_RET,$columns,_('Anomalous Grade'),_('Anomalous Grades'),$link,array(),array('center'=>false,'save'=>false,'search'=>false));

function _makePoints($value,$column)
{	global $THIS_RET;

	if($value=='')
		return '<FONT class=red>'._("Missing").'</FONT>';
	elseif($value=='-1')
		return '<FONT color=#00a000>'._("Excused").'</FONT>';
	elseif($value<0)
		return '<FONT class=red>'._("Negative!").'</FONT>';
