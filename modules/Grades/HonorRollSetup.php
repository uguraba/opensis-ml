...
if(!$_REQUEST['modfunc'])
{
                       ...
                       $functions = array('TITLE'=>'_makeTextInput', 'VALUE'=>'makeTextInputt');
                        $LO_columns = array('TITLE'=>_('Honor Roll'),
                                                    'VALUE'=>''._('Breakoff').'');
                       ...
                       $link['remove']['variables'] = array('id'=>'ID');
                        ...
                        $tabs = array();
                       $tabs[] = array('title'=>_('Honor Roll Setup'));
                        ...
                        echo '<BR>';
                        echo '<CENTER>'.SubmitButton(_('Save'),'','class=btn_medium onclick="formcheck_honor_roll();"').'</CENTER>';
                        PopTable ('footer');
                        echo '</div>';
                        echo '</FORM>';
