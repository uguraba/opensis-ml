...
echo '<div id="calculating" style="display: none; padding-top:20px; padding-bottom:15px;"><img src="assets/missing_attn_loader.gif" /><br/><br/><br/><span style="color:#c90000;"><span style=" font-size:15px; font-weight:bold;">'._('Please wait.').'</span><br /><span style=" font-size:12px;">'._('Recalculating GPA . Do not click anywhere.').'</span></span></div>
...
//{	
    ...
    echo '<CENTER><h4>'._('When do you want to recalculate the running GPA numbers').'?</CENTER></h4><br/>';
...
if(!$_REQUEST['modfunc'])
{
	...
	if($_REQUEST['search_modfunc']=='list')
	{
            if($_SESSION['count_stu']!=0)
               echo '<BR><CENTER>'.SubmitButton(_('Recalculate GPA'),'','class=btn_re_enroll').'</CENTER>';
