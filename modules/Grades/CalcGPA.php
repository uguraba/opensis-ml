...
echo '<div id="calculating" style="display: none; padding-top:20px; padding-bottom:15px;"><img src="assets/missing_attn_loader.gif" /><br/><br/><br/><span style="color:#c90000;"><span style=" font-size:15px; font-weight:bold;">'._('Please wait.').'</span><br /><span style=" font-size:12px;">'._('Calculating GPA . Do not click anywhere.').'</span></span></div>
...
$table = '<TABLE><TR><TD valign=top><TABLE>
		...
		<TD align=right valign=top><font color=gray>'._('Calculate GPA for').'</font></TD>
		<TD>';
...
$table .= '</TD>
	...
	<TR>
		<TD colspan = 2 align=center><font color=gray>'._('GPA based on a scale of ').''.$SCALE_RET[1]['REPORTING_GP_SCALE'].'</TD>
	</TR>'.
//	<TR>
...
echo '<CENTER><h4>'._('Calculate GPA and Class Rank').'</CENTER></h4><br/>';
...
//}
echo '<BR><CENTER>'.SubmitButton(_('Calculate GPA'),'','class=btn_re_enroll').'</CENTER>';
echo "</FORM>";
}
