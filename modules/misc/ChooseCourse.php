...
else
{
	...
	echo "<script language=javascript>opener.document.getElementById(\"course_div\").innerHTML = \"$course_title<BR><small><INPUT type=radio name=w_course_period_id_which value=course_period CHECKED>"._('Course Period')."<INPUT type=radio name=w_course_period_id_which value=course>"._('Course')." </small>\"; window.close();</script>";
}
