...
error_reporting(0);
include('../data.php');
	$dbconn = mysql_connect($DatabaseServer, $DatabaseUsername, $DatabasePassword) or die();
  ...
  from TABLES t
	...
	where t.table_schema='".$DatabaseName."' and t.table_name like '%_seq' and t1.table_name<>'schedule'
  union
