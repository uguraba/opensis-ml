...
fclose($fh);
$display_text='Your system has been successfully upgraded to version 5.3. Please click the Login button to proceed to login with your existing login credentials.
';
