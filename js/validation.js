			...
			for(var i=1; i<sel.length; i++)
			{
				...
				else if(inp_value != "")
				{
					...
					else if(inp_name1 == 'values[E_MAIL]')
					{
						...
						{
							document.getElementById('divErr').innerHTML="<b><font color=red>"+unescape(_("Please enter a valid email address."))+"</font></b>";
							return false;
						}
					}
...
document.getElementById('divErr').innerHTML="<b><font color=red>"+strError+"</font></b>";
	...
	function formcheck_school_setup_marking(){
  	...
  	frmvalidator.addValidation("tables[new][TITLE]","req",_("Please enter the title"));
  	frmvalidator.addValidation("tables[new][TITLE]","maxlen=50", "Max length for title is 50 characters");
	
	frmvalidator.addValidation("tables[new][SHORT_NAME]","req",_("Please enter the short name"));
...
if (false==isDate(sm, sd, sy))
   {
   document.getElementById("divErr").innerHTML="<b><font color=red>"+""._('Please enter the start date.')+"</font></b>";
   sm.focus();
   return false;
   }
}
...
{  
   ...
   {
  document.getElementById("divErr").innerHTML="<b><font color=red>"+""._('Please enter the end date.')+"</font></b>";
   em.focus();
   return false;
   }
}   
...
{  
   if (false==isDate(psm, psd, psy))
   {
  document.getElementById("divErr").innerHTML="<b><font color=red>"+""._('Please enter the grade posting start date.')+"</font></b>";
   psm.focus();
   return false;
   }
}   
...
{
	var frmvalidator  = new Validator("prompt_form");
	frmvalidator.addValidation("title","req",_("Please enter the title"));
...
function formcheck_school_setup_periods()
{
	...
	if(p_name_val != "")
	{
		...
		frmvalidator.addValidation("values[new][TITLE]","maxlen=50", _("Max length for title is 50 characters"));
		
		frmvalidator.addValidation("values[new][SHORT_NAME]","maxlen=50", _("Max length for short name is 50 characters"));
		
		frmvalidator.addValidation("values[new][SORT_ORDER]","num", _("Sort order allows only numeric value"));
		frmvalidator.addValidation("values[new][SORT_ORDER]","maxlen=5", _("Max length for sort order is 5 digits"));
		
		frmvalidator.addValidation("values[new][START_HOUR]","req",_("Please select start time"));
		frmvalidator.addValidation("values[new][START_MINUTE]","req",_("Please select start time"));
		frmvalidator.addValidation("values[new][START_M]","req",_("Please select start time"));
		
		frmvalidator.addValidation("values[new][END_HOUR]","req",_("Please select end time"));
		frmvalidator.addValidation("values[new][END_MINUTE]","req",_("Please select end time"));
		frmvalidator.addValidation("values[new][END_M]","req",_("Please select end time"));
	} 
...
function formcheck_student_student()
{
	...
	frmvalidator.addValidation("values[address][ADDRESS]","req",(_("Please enter address")));
...
if(result==true)
 ...
 function studentcheck_unmatch (err) {
	...
	function formcheck_student_studentField_F2()
	{
		var frmvalidator  = new Validator("F2");
		frmvalidator.addValidation("tables[new][TITLE]","req",_("Please enter the title"));
		frmvalidator.addValidation("values[TITLE]","maxlen=100", _("Max length for school name is 100 characters"));
		
		frmvalidator.addValidation("tables[new][SORT_ORDER]","num", _("sort order code allows only numeric value"));
	}
	...
	{
		var frmvalidator  = new Validator("F1");
		frmvalidator.addValidation("tables[new][TITLE]","req",_("Please enter the field name"));
		
		
		frmvalidator.addValidation("tables[new][TYPE]","req",_("Please select the data type"));
		
		frmvalidator.addValidation("tables[new][SORT_ORDER]","num", _("sort order allows only numeric value"));
	}
...
///////////////////////////////////////// Contact Field Start //////////////////////////////////////////////////////////
	...
	function formcheck_user_user(staff_school_chkbox_id){
  	...
  	frmvalidator.addValidation("staff[FIRST_NAME]","req",_("Please enter the first name"));
//	frmvalidator.addValidation("staff[FIRST_NAME]","alphabetic", "First name allows only alphabetic value");
  	frmvalidator.addValidation("staff[FIRST_NAME]","maxlen=100", _("Max length for first name is 100 characters"));
	
		
	frmvalidator.addValidation("staff[LAST_NAME]","req",_("Please enter the Last Name"));
//	frmvalidator.addValidation("staff[LAST_NAME]","alphabetic", "Last name allows only alphabetic value");
  	frmvalidator.addValidation("staff[LAST_NAME]","maxlen=100", _("Max length for Address is 100"));
        frmvalidator.addValidation("staff[PASSWORD]","password=8", _("Password should be minimum 8 characters with one special character and one number"));
	frmvalidator.addValidation("staff[PROFILE]","req",_("Please select the user profile"));
        frmvalidator.addValidation("staff[EMAIL]","email", "Please enter a valid email");
	frmvalidator.addValidation("staff[PHONE]","ph",_("Please enter a valid telephone number"));
...
//                                    }
                                    ...
                                    {
                                      var d = $('divErr');
                                       var err_stardate = _("Start date cannot be greater than end date.");
...
/////////////////////////////////////////  User Fields Start  //////////////////////////////////////////////////////////
	...
	function formcheck_user_userfields_F2()
	{
		var frmvalidator  = new Validator("F2");
		frmvalidator.addValidation("tables[new][TITLE]","req",_("Please enter the title"));
		frmvalidator.addValidation("tables[new][TITLE]","alphabetic", _("Title allows only alphabetic value"));
		frmvalidator.addValidation("tables[new][TITLE]","maxlen=50", _("Max length for title is 100"));
	}
	
	function formcheck_user_userfields_F1()
	{
		var frmvalidator1  = new Validator("F1");
		frmvalidator1.addValidation("tables[new][TITLE]","req",_("Please enter the field Name"));
		frmvalidator1.addValidation("tables[new][TITLE]","req", _("Field name allows only alphanumeric value"));
		frmvalidator1.addValidation("tables[new][TITLE]","maxlen=50", _("Max length for Field Name is 100"));
                //frmvalidator1.addValidation("tables[new][SORT_ORDER]","req","Please enter the sort order");
                frmvalidator1.addValidation("tables[new][SORT_ORDER]","num", _("sort order allows only numeric value"));
	}
...
function formcheck_scheduling_course_F4()
{
	var frmvalidator  = new Validator("F4");
  	frmvalidator.addValidation("tables[course_subjects][new][TITLE]","req",_("Please enter the title"));
  	frmvalidator.addValidation("tables[course_subjects][new][TITLE]","maxlen=100", _("Max length for title is 100"));
}

function formcheck_scheduling_course_F3()
{
	var frmvalidator  = new Validator("F3");
  	frmvalidator.addValidation("tables[courses][new][TITLE]","req",_("Please enter the title"));
  	frmvalidator.addValidation("tables[courses][new][TITLE]","maxlen=50", _("Max length for title is 50"));
	
  	frmvalidator.addValidation("tables[courses][new][SHORT_NAME]","req",_("Please enter the short name"));
  	frmvalidator.addValidation("tables[courses][new][SHORT_NAME]","maxlen=10", _("Max length for short name is 10"));
}
...
function formcheck_scheduling_course_F2()
{
    var count;
    var check=0;
    if(document.getElementById("get_status").value=='false' && document.getElementById('cp_id').value!='new')
    {
...
//        document.getElementById("cp_period").focus();
    ...
    {    
	var frmvalidator  = new Validator("F2");
  	frmvalidator.addValidation("tables[course_periods][new][SHORT_NAME]","req",_("Please enter the short name"));
  	frmvalidator.addValidation("tables[course_periods][new][SHORT_NAME]","maxlen=20", _("Max length for short name is 20"));

  	frmvalidator.addValidation("tables[course_periods][new][TEACHER_ID]","req",_("Please select the teacher"));

  	frmvalidator.addValidation("tables[course_periods][new][ROOM]","req",_("Please enter the Room"));
  	frmvalidator.addValidation("tables[course_periods][new][ROOM]","maxlen=10", _("Max length for room is 10"));
	
  	frmvalidator.addValidation("tables[course_periods][new][PERIOD_ID]","req",_("Please select the period"));
	frmvalidator.addValidation("tables[course_periods][new][MARKING_PERIOD_ID]","req",_("Please select marking period"));
	frmvalidator.addValidation("tables[course_periods][new][TOTAL_SEATS]","req",_("Please input total seats"));
	frmvalidator.addValidation("tables[course_periods][new][TOTAL_SEATS]","maxlen=10",_("Max length for seats is 10"));
...
{
    var frmvalidator  = new Validator("F1");
    frmvalidator.addValidation("values[new][TITLE]","maxlen=50", _("Max length for title is 50"));
    frmvalidator.addValidation("values[new][SHORT_NAME]","maxlen=50", _("Max length for short name is 50"));
    frmvalidator.addValidation("values[new][SORT_ORDER]","num", _("Sort order allows only numeric value"));
    frmvalidator.addValidation("values[new][SORT_ORDER]","maxlen=5", _("Max length for sort order is 5"));
...
function formcheck_honor_roll()
{
    ...
    frmvalidator.addValidation("values[new][VALUE]","maxlen=50", _("Max length for Short Name is 50"));
}
...
function formcheck_grade_comment()
{
		...
		frmvalidator.addValidation("values[new][SORT_ORDER]","num", _("ID allows only numeric value"));
		
		frmvalidator.addValidation("values[new][TITLE]","maxlen=50", _("Max length for Comment is 50"));
...
function formcheck_eligibility_activies()
{
	...
	function ValidateDate_eligibility_activies()
	{
		...
		{  
		   if (false==isDate(psm, psd, psy))
		   {
			   alert(_("Please enter the grade posting start date"));
			   psm.focus();
			   return false;
		   }
		}   
...
function formcheck_mass_drop()
{
    ...
    {    
        alert(_("Please choose a course period to drop"));
        return false;
    }
    else
        return true;
...
function formcheck_attendance_codes()
{
        ...
        {
            var frmvalidator  = new Validator("F1");
            frmvalidator.addValidation("values[new][TYPE]","req","Please select type");
...
function formcheck_assignments()
{
           ...
           frmvalidator.addValidation("tables[new][POINTS]","req","Please Enter Total points");
           frmvalidator.addValidation("month_tables[new][ASSIGNED_DATE]","req",_("Month cannot be blank"));
           frmvalidator.addValidation("day_tables[new][ASSIGNED_DATE]","req",_("Day cannot be blank"));
           frmvalidator.addValidation("year_tables[new][ASSIGNED_DATE]","req",_("Year cannot be blank"));
            frmvalidator.addValidation("month_tables[new][DUE_DATE]","req",_("Month cannot be blank"));
           frmvalidator.addValidation("day_tables[new][DUE_DATE]","req",_("Day cannot be blank"));
           frmvalidator.addValidation("year_tables[new][DUE_DATE]","req",_("Year cannot be blank"));
}
...
function passwordMatch()
{
    ...
    if(new_pass || vpass)
    {
        if(new_pass==vpass)
        {
            ...
            document.getElementById("passwordMatch").innerHTML = _("Password Match") ;
        }
        if(new_pass!=vpass)
        {
            document.getElementById("passwordMatch").style.display = "block" ;
            document.getElementById("passwordMatch").style.backgroundColor = "#ff0000" ;
            document.getElementById("passwordMatch").innerHTML = _("Password MisMatch") ;    
        }
    }
