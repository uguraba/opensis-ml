...
{	global $_openSIS;
	...
	switch($type)
	{
		...
		case 'general_info':
			echo '<tr><td align=right width=120>'._('Last')._(' ')._('Name').'</td><td><input type=text name="last" size=30 class="cell_floating"></td></tr>';
			echo '<tr><td align=right width=120>'._('First Name').'</td><td><input type=text name="first" size=30 class="cell_floating"></td></tr>';
			echo '<tr><td align=right width=120>'._('Student ID').'</td><td><input type=text name="stuid" size=30 class="cell_floating"></td></tr>';
		        echo '<tr><td align=right width=120>'._('Alt ID').'</td><td><input type=text name="altid" size=30 class="cell_floating"></td></tr>';
                        echo '<tr><td align=right width=120>'._('Address').'</td><td><input type=text name="addr" size=30 class="cell_floating"></td></tr>';
			...
			echo '<TR><TD align=right width=120>'._('Grade').'</TD><TD><SELECT name=grade><OPTION value="" class="cell_floating">'._('Not Specified').'</OPTION>';
		...
		case 'student_fields':
			...
			if(count($search_fields_RET['numeric']))
			{
				foreach($search_fields_RET['numeric'] as $column)
					echo "<TR><TD align=right width=120>$column[TITLE]</TD><TD>"._('Between')." <INPUT type=text name=cust_begin[{$column[COLUMN_NAME]}] size=3 maxlength=11 class=\"cell_floating\"> &amp; <INPUT type=text name=cust_end[{$column[COLUMN_NAME]}] size=3 maxlength=11 class=\"cell_small\"></TD></TR>";
			}
			echo '</TABLE><TABLE>';
			if(count($search_fields_RET['codeds']))
			{
				foreach($search_fields_RET['codeds'] as $column)
				{
					...
					echo "<SELECT name=cust[{$column[COLUMN_NAME]}] style='max-width:250;'><OPTION value=''>N/A</OPTION><OPTION value='!'>"._('No Value')."</OPTION>";
			...
			if(count($search_fields_RET['radio']))
			{
				...
				echo "<TR><TD></TD><TD><table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>"._('All')."</b></td><td width=30><b>Yes</b></td><td width=25><b>No</b></td></tr></table></TD><TD></TD><TD></TD><TD>";
				if(count($search_fields_RET['radio'])>1)
					echo "<table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>All</b></td><td width=30><b>"._('Yes')."</b></td><td width=25><b>No</b></td></tr></table>";
				echo "</TD></TR>";
...
unset($_SESSION['student_id']);
	switch($type)
	{
		...
		case 'general_info':
			echo '<tr><td align=right width=120>'._('Last Name').'</td><td><input type=text name="last" size=30 class="cell_floating"></td></tr>';
			echo '<tr><td align=right width=120>'._('First Name').'</td><td><input type=text name="first" size=30 class="cell_floating"></td></tr>';
			echo '<tr><td align=right width=120>'._('Student ID').'</td><td><input type=text name="stuid" size=30 class="cell_floating"></td></tr>';
			echo '<tr><td align=right width=120>'._('Alt ID').'</td><td><input type=text name="altid" size=30 class="cell_floating"></td></tr>';
                        echo '<tr><td align=right width=120>'._('Address').'</td><td><input type=text name="addr" size=30 class="cell_floating"></td></tr>';
			...
			$list = DBGet(DBQuery("SELECT DISTINCT TITLE,ID,SORT_ORDER FROM school_gradelevels WHERE SCHOOL_ID='".UserSchool()."' ORDER BY SORT_ORDER"));
			echo '<TR><TD align=right width=120>Grade</TD><TD><SELECT name=grade><OPTION value="" class="cell_floating">'._('Not Specified').'</OPTION>';
			foreach($list as $value)
		...
		case 'student_fields':
			...
			if(count($search_fields_RET['autos']))
			{
				foreach($search_fields_RET['autos'] as $column)
				{
					...
					echo "<TR><TD align=right width=120>$column[TITLE]</TD><TD>";
					echo "<SELECT name=cust[{$column[COLUMN_NAME]}] style='max-width:250;'><OPTION value=''>"._('N/A')."</OPTION><OPTION value='!'>No Value</OPTION>";
					$options = array();
					foreach($options_RET as $option)
					{
						echo "<OPTION value=\"$option\">$option</OPTION>";
			...
			{
				foreach($search_fields_RET['date'] as $column)
					echo "<TR><TD colspan=2>$column[TITLE]<BR> &nbsp; &nbsp;"._(' Between')." ".PrepareDate('','_cust_begin['.$column['COLUMN_NAME'].']',true,array('short'=>true)).' & '.PrepareDate('','_cust_end['.$column['COLUMN_NAME'].']',true,array('short'=>true))."</TD></TR>";
			}
			if(count($search_fields_RET['radio']))
			{
				echo '<TR><TD colspan=2><BR></TD></TR>';
				...
				echo "<TR><TD></TD><TD><table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>"._('All')."</b></td><td width=30><b>"._('Yes')."</b></td><td width=25><b>"._('No')."</b></td></tr></table></TD><TD></TD><TD></TD><TD>";
				if(count($search_fields_RET['radio'])>1)
					echo "<table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>"._('All')."</b></td><td width=30><b>"._('Yes')."</b></td><td width=25><b>"._('No')."</b></td></tr></table>";
				echo "</TD></TR>";
	...
	switch($type)
	{
		...
		case 'student_fields':
			...
			if(count($search_fields_RET['radio']))
			{
				...
				echo "<TR><TD></TD><TD><table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>"._('All')."</b></td><td width=30><b>Yes</b></td><td width=25><b>"._('No')."</b></td></tr></table></TD><TD></TD><TD></TD><TD>";
				if(count($search_fields_RET['radio'])>1)
					echo "<table border=0 cellpadding=0 cellspacing=0><tr><td width=25><b>"._('All')."</b></td><td width=30><b>"._('Yes')."</b></td><td width=25><b>"._('No')."</b></td></tr></table>";
				echo "</TD></TR>";
