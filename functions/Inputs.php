...
function SearchDateInput($day,$month,$year,$allow_day,$allow_month,$allow_year)
{
	...
	if($allow_month == 'Y')
	{
		...
		$dt.='<option value="">'._('Month').'</option><option value='._("01").'>'._('January').'</option><option value='._("02").'>'._('February').'</option><option value='._("03").'>'._('March').'</option><option value='._("04").'>'._('April').'</option><option value='._("05").'>'._('May').'</option><option value='._("06").'>'._('June').'</option><option value='._("07").'>'._('July').'</option><option value='._("08").'>'._('August').'</option><option value='._("09").'>'._('September').'</option><option value='._("10").'>'._('October').'</option><option value='._("11").'>'._('November').'</option><option value='._("12").'>'._('December').'</option>';
		$dt.='</select>';
	}
