	...
	if($_LIST['output']!=false)
	{
		...
		if($options['count'] || $display_zero)
		{
			if(($result_count==0 || $display_count==0) && $plural)
				echo "<table class=alert_center><tr><td class=alert_center_padding><b>"._('No')." "._($plural)." "._('were found.')."</b></td></tr></table>";
			elseif($result_count==0 || $display_count==0)
				echo '<table class=alert_center><tr><td class=alert_center_padding><b>'._('None were found.').'</b></td></tr></table>';
		}
