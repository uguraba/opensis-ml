...
function required_param($parname, $type=PARAM_CLEAN)
{
    if (isset($_POST[$parname])) {       // POST has precedence
        ...
        echo ''._('A required parameter').' ('.$parname.') '._('was missing').'';
    }
...
function clean_param($param, $type) {
    ...
    switch ($type) {
        ...
        case PARAM_PERCENT:
           // return preg_replace('/[^0-9%.]/i', '', $param);  // Remove everything not 0-9.%
	   ...
	   return preg_replace('/[^\sa-zA-Z#&]/i', '', $param);
           // return replace_croatain($param);
        ...
        case PARAM_ALPHANUMS:     // Remove everything not a-zA-Z -,
           return preg_replace('/[^\sa-zA-Z0-9-,.#&]/i', '', $param);
           // return replace_croatain($param);
       ...
       case PARAM_URL:          // allow safe ftp, http, mailto urls
        ...
        default:                 // throw error, switched parameters in optional_param or another serious problem
            echo ""._('Unknown parameter type:')." $type";
    }
}
...
function validateUrlSyntax( $urladdr, $options="" ){
    ...
    {
        trigger_error(""._('Options attribute malformed')."", E_USER_ERROR);
    }
